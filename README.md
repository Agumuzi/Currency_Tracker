...
主要原因是它更适合放在前面做主力刷新。官方定价页和 API 文档显示，免费计划提供 每天 800 API credits。按照这个项目当前的请求方式，一次完整刷新大约会消耗 8 credits，所以实际可以大致理解为 每天约 100 次刷新，对个人使用已经很充足了。 ￼
...
Twelve Data 官网和文档见官方页面。 ￼

Open Exchange Rates

Open Exchange Rates 在这个项目里更像一个稳定的备用方案。

它免费计划的规则非常清楚：官方写明免费层是 每月 1,000 次请求，并且免费计划是 按小时更新。官方 FAQ 还特别说明，小时级数据通常会在每小时开始后的 1 到 2 分钟左右刷新。 ￼
...
另外，官方也明确写了它覆盖 200 多种货币，并提供实时和历史汇率数据。 ￼

Open Exchange Rates 官网和文档见官方页面。 ￼
